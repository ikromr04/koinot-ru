  ...
  <main class="main-page">
      ...
      <div class="glide banner">
        ...
        <div class="banner__content">
          <div class="banner__container container">
            <h2 class="banner__title">Группа компаний <br> "КОИНОТИ НАВ"</h2>
    ...
    <section class="main-page__news">
      ...
      <div class="main-page__news-container container">
        <div class="content">
          <h2>Наши новости</h2>
          <p class="main-page__news-description">Новости, история развития и интересные события из нашей жизни, <br>
